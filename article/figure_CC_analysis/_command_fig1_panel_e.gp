...
# create legend
set label '({/Symbol s},{/Symbol g})' at 150,-0.6 left
set arrow nohead from 135,-0.6 to 147.5,-0.6 lw 4 lc "#FF0000"
set label '({/Symbol s},{/Symbol k})' at 150,-0.75 left
set arrow nohead from 135,-0.75 to 147.5,-0.75 lw 4 lc "#0000FF"
set label '({/Symbol s},{/Symbol h})' at 150,-0.9 left
...
#put panel label
set label '(e)' at 157,0.925

# plot data
p "crosscorr_groundpdf_matrixformat_allsites_sigmavsgamma" u 1:2 title "" w l lt 1 lw 2 lc "#FF0000","crosscorr_groundpdf_matrixformat_allsites_sigmavskappa" u 1:2 title "" w l lt 1 lw 2 lc "#0000FF","crosscorr_groundpdf_matrixformat_allsites_sigmavseta" u 1:2 title "" w l lt 1 lw 2 lc "#00CD00",0 title "" w l lt 1 lc "#000000" lw 3
