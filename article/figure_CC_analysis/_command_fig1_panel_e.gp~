...
# create legend
set label '({/Symbol m},{/Symbol s})' at 150,-0.6 left
set arrow nohead from 135,-0.6 to 147.5,-0.6 lw 4 lc "#FF0000"
set label '({/Symbol m},{/Symbol g})' at 150,-0.75 left
set arrow nohead from 135,-0.75 to 147.5,-0.75 lw 4 lc "#0000FF"
set label '({/Symbol m},{/Symbol h})' at 150,-0.9 left
set arrow nohead from 135,-0.9 to 147.5,-0.9 lw 4 lc "#00CD00"
set label '({/Symbol m},{/Symbol n})' at 115,-0.6 left
...
#put panel label
set label '(c)' at 157,0.925

# plot data
p "crosscorr_groundpdf_matrixformat_allsites_muvssigma" u 1:2 title "" w l lt 1 lw 2 lc "#FF0000","crosscorr_groundpdf_matrixformat_allsites_muvsgamma" u 1:2 title "" w l lt 1 lw 2 lc "#0000FF","crosscorr_groundpdf_matrixformat_allsites_muvskappa" u 1:2 title "" w l lt 1 lw 2 lc "#00CD00","crosscorr_groundpdf_matrixformat_allsites_muvseta" u 1:2 title "" w l lt 1 lw 2 lc "#00BFFF",0 title "" w l lt 1 lc "#000000" lw 3
